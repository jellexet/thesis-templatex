...
\]
In a typical scenario, with the new formatting the network buffer would be able to contain over \text{40\%} more messages within the same size, which corresponds to a notable increase in throughput.