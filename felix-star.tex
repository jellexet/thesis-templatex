...
\begin{lstlisting}[caption={FELIX Identifier Fields - 64 bits}, label={lst:felix_identifier}]
+------------+-------------+--------------+---------+--------------+-----------+
|   4 bits   |    8 bits   |   16 bits    | 14 bits |   14 bits    |  8 bits   |
+------------+-------------+--------------+---------+--------------+-----------+
| Version ID | Detector ID | Connector ID | Link ID | Transport ID | Stream ID |
+------------+-------------+--------------+---------+--------------+-----------+
\end{lstlisting}
...
\caption[Grafana screenshot: select one E-link]{Here a screenshot showing that it is possible to select and focus one element at a time, in this case I selected the \acs{E-link} 0x2400000.}
